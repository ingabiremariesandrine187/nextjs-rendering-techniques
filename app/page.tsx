...
return(
   <div className="container mx-auto px-4 py-8">
      ...
      <section className="text-center py-8 md:py-16 px-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">
          Welcome to NextBlog
        </h1>
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-6 md:mb-8 max-w-2xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
          <Link href="/blog" className="btn-primary flex items-center space-x-2 w-full sm:w-auto justify-center">
      ...
      {/* CSR Demo Section */}
      <section className="py-8 md:py-12 px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8 text-gray-800 dark:text-white">
